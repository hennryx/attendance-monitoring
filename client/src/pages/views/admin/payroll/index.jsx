                    ...
                    <tr key={payroll._id}>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="font-medium text-gray-900">
                          {payroll.staffId?.firstname}{" "}
                          {payroll.staffId?.lastname}
                        </div>
                        <div className="text-sm text-gray-500">
                          {payroll.staffId?.employeeId || "N/A"}
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div>
                          {format(new Date(payroll.periodStart), "MMM d, yyyy")}
                        </div>
                        <div>
                        ...
                        <div className="flex justify-end space-x-2">
                          ...
                          {payroll.paymentStatus === "pending" && (
                            <button
                              className="text-blue-600 hover:text-blue-900"
                              onClick={() =>
                                handleUpdateStatus(payroll._id, "processing")
                              }
              ...
              <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-gray-700">
                    ...
                    of <span className="font-medium">{payrolls.length}</span>{" "}
                    results
                  </p>
                </div>
                <div>
                  ...
                  >
                    ...
                    {[
                      ...Array(
                        Math.ceil(payrolls.length / itemsPerPage)
                      ).keys(),
                    ].map((number) => (
                      <button
                        key={number + 1}
