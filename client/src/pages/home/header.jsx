      ...
      >
        ...
        <div className="hidden lg:flex lg:gap-x-12 lg:justify-end">
          {navigation.map((item) => (
            ...
            >
              <span className="text-black" style={{ textWrap: "nowrap" }}>
                {item.name}
              </span>
            </NavLink>
          ))}
          ...
          <button
            className="btn border btn-ghost text-base font-semibold leading-6 text-gray-900 p-2 rounded-md hover:bg-white"
