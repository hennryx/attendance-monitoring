...
import { FaBell, FaCheckCircle, FaEye, FaRegClock, FaCalendarAlt, FaExclamationCircle } from 'react-icons/fa';
...
const NotificationsPage = () => {
    ...
    const handleNotificationClick = async (notification) => {
        ...
        if (notification.type === 'absence_reason') {
    ...
    return (
        <div className="relative isolate min-h-lvh overflow-hidden bg-[linear-gradient(to_bottom,#1b1b1b_25%,#FAFAFA_25%)]">
            ...
            <div className="container mx-auto p-4">
                <h1 className="text-3xl font-semibold mb-6 text-white">Notifications</h1>
